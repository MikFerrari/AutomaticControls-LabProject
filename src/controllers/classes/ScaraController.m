classdef ScaraController < BaseController
    ...
    methods
        ...
        function setUMax(obj,umax)
            ...
            obj.ctrl_joint1.setUMax(obj.umax(1));    % limite di coppia giunto 1
            obj.ctrl_joint2.setUMax(obj.umax(2));    % limite di coppia giunto 2
        end
        ...
        function u=computeControlAction(obj,reference,y)
            %% calcolo azione di controllo del robot
            % setpoint di posizione, velocità, accelerazione per ogni giunto
            sp_pos1=reference(1);
            sp_pos2=reference(2);
            sp_vel1=reference(3);
            sp_vel2=reference(4);
            ...
            % misure di posizione e velocità per ogni giunto
            pos1=y(1);
            pos2=y(2);
            vel1=y(3);
            vel2=y(4);
