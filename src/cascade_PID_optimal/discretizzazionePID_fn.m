...
% DISCRETIZZAZIONE_PID Discretizza il controllore PID filtrato escludendo l'azione integrale.
%   
%   La separazione dell'azione integrale dal resto del controllore
%   permette la corretta implementazione dell'antiwindup, che deve agire
%   solamente sulla parte integrale.
%
%   Parametri:
%   - Kp,Ki,Kd,Tfd,Tfu: parametri del controllore
