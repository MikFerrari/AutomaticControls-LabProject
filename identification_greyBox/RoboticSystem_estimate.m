classdef RoboticSystem_estimate < MechanicalSystem
    ...
    methods  (Access = public)
        function obj=RoboticSystem_estimate(st,robot,hm,cm,umax,elastic_joints,Jm,k,h)
    ...
    methods  (Access = protected)
        ...
        function y=outputFunction(obj)
            if (obj.elastic_joints)
                y=obj.x(2*obj.njoints+(1:2*obj.njoints))+obj.sigma_y.*randn;
            else
                y=obj.x+obj.sigma_y.*randn;
            end
        end
    end
end
